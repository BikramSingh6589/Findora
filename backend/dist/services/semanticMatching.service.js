...
exports.compareSemanticText = exports.detectPrimaryObject = exports.extractMainObject = void 0;
...
exports.extractMainObject = extractMainObject;
// Get primary object type from words list
const detectPrimaryObject = (words) => {
    return (0, exports.extractMainObject)(words.join(' '));
};
...
const compareSemanticText = (textA, textB) => {
    ...
    const primaryObjA = (0, exports.extractMainObject)(textA);
    const primaryObjB = (0, exports.extractMainObject)(textB);
